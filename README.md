...
Behind the scenes this will also call `bower install`.  After that, you should find out that you have two new
...
Angular apps are really just a bunch of static HTML, CSS and JavaScript files that just need to be hosted
